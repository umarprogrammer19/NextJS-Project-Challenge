...
const Section: React.FC<SectionProps> = ({
    ...
    return (
        <section className="py-20 bg-gray-100">
            <div className={`container mx-auto px-6 flex flex-col ${reverse ? 'md:flex-row-reverse' : 'md:flex-row'} items-center justify-between ${marginTop && 'mt-24'} max-w-screen-xl`}>
                {/* Image */}
                ...
                <div className="md:w-1/2 text-center md:text-left">
                    <h2 className="text-5xl font-bold text-gray-800 mb-4">{heading}</h2>
                    <p className="text-xl text-gray-600 mb-6">{text}</p>
